...
import { attachStage, finalizeJob, getJob } from "@/lib/job/store";
...
const STAGE_MAP: Record<string, { n: 2 | 3 | 4; sig: RawStage }> = {
  "2": { n: 2, sig: "stage2" },
  "3": { n: 3, sig: "stage3" },
  "4": { n: 4, sig: "stage4" },
};
...
export async function POST(
  ...
  if (!stage) {
    return NextResponse.json({ error: "n must be 2|3|4" }, { status: 400 });
  }
